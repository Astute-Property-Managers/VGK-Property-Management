...
/**
 * Security notice for browser/local storage usage
 */
export const SECURITY_NOTICE = `
⚠️ SECURITY NOTICE: This browser application currently uses localStorage for persistence in this version.
For production use with sensitive financial data:
1. Implement user authentication and authorization
2. Use HTTPS and secure API communication for all server interactions
